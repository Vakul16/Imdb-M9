...
// const  http://www.omdbapi.com/?i=tt3896198&apikey=f558f00a;
  ...
  render() {
    ...
    <Header className="header">
      ...
      <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['2']}>
        ...
        <Menu.Item key="4">MDetails</Menu.Item>
        <Menu.Item key="5">Watchlist</Menu.Item>
        <Menu.Item key="6">Movie</Menu.Item>
    ...
    <Content style={{ padding: '0 50px' }}>
      ...
      <Layout className="site-layout-background" style={{ padding: '24px 0' }}>
        ...
        <Content style={{ padding: '0 40px', minHeight: 280 }}>Content</Content>
      </Layout>
    </Content>
